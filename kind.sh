...
argo_cd_chart_version=8.5.8
argo_rollouts_chart_version=2.40.4
...
# argocd login localhost:31443 --username admin --password admin  --insecure

kargo create credentials github-creds \
  --project kargo-advanced \
  --git \
  --username rajdeepsignzy \
  --repo-url https://github.com/rajdeepsignzy/kargo-advanced.git

docker buildx imagetools create \
  ghcr.io/akuity/guestbook:latest \
  -t ghcr.io/rajdeepsignzy/guestbook:v0.0.2